  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card": "0 2px 12px oklch(0.18 0.04 243 / 0.08)",
        "card-hover": "0 8px 32px oklch(0.18 0.04 243 / 0.14)",
        "navy": "0 4px 24px oklch(0.18 0.04 243 / 0.25)",
        "sage": "0 4px 16px oklch(0.63 0.07 145 / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
